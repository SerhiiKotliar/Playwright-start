# from a playwright.async_api import expect
# from a playwright.async_api import async_playwright
import re
import pytest
...
#         try:
#             await a locator.wait_for(state='visible', timeout=10000)  # ждём элемент до 10 секунд
#             await a locator.scroll_into_view_if_needed()
#             await locator.hover()
#         except TimeoutError:
