...
def test_first_name_field(page_open, scenario, expected_result, user_data):
    ...
    # if scenario == "visible":
        allure.dynamic.title(f"Позитивний тест: поле 'First Name*' відображається → {expected_result}")
        ...
        allure.dynamic.title(f"Негативний тест: поле 'First Name*' відсутнє у DOM → {expected_result}")
